...
function populate(container, data) {
	...
	$('.date', container).text(dateFormat(data.date, 'UTC:dd.mm.yyyy HH:MM:ss'));
}

// https://raw.github.com/felixge/node-dateformat/master/lib/dateformat.js until there is a component for this stuff
/*
 * Date Format 1.2.3
